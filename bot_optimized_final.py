...
async def create_bot_with_flood_control():
    """
    Create bot with proper flood control handling
    """
    global bot, dp
    ...
    try:
        ...
        # Set bot commands with flood control
        try:
...
# Export functions
__all__ = ['bot', 'dp', 'router', 'create_bot_with_flood_control']