...
def handle_callback_query(callback_query):
    ...
    if data == "ai_activate":
        if chat_id in user_data:
            ...
            edit_message_text(chat_id, message_id, "🤖 هوش مصنوعی فعال شد!\n\nاکنون می‌توانید متن مورد نظر خود را برای تبدیل به استیکر وارد کنید.", reply_markup=keyboard)
        return
        ...
        if chat_id in user_data:
            ...
            edit_message_text(chat_id, message_id, "🤖 هوش مصنوعی غیرفعال شد!\n\nبرای استفاده از قابلیت هوش مصنوعی، روی دکمه «🤖 فعال کردن هوش مصنوعی» کلیک کنید.", reply_markup=keyboard)
        return
    ...
    if "text" in msg:
        ...
        if text == "🎁 تست رایگان":
            ...
            send_message(chat_id, "🎁 از تست رایگان استفاده کنید!\n\nبا استفاده از دکمه‌های زیر می‌توانید استیکر بسازید:", reply_markup=keyboard)
            return "ok"
...
def process_message(msg):
    ...
    try:
        ...
        if "text" in msg:
            ...
            send_message(chat_id, "🎭 استیکرساز معمولی فعال شد!\n\nلطفاً متن مورد نظر خود را برای تبدیل به استیکر وارد کنید یا از دکمه‌های زیر استفاده کنید.", reply_markup=keyboard)
            return "ok"
