...
def get_font(size):
    """بارگذاری فونت با fallback برای فونت‌های مختلف"""
    font_paths = [
        "Vazir.ttf",
...
def make_text_sticker(text, path, background_file_id=None):
    try:
        ...
        try:
            ...
            # اگر textbbox کار نکرد، از textsize استفاده کن
            try:
        ...
        try:
            ...
            # fallback: رسم متن بدون فونت خاص
