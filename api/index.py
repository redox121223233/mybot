...
async def initialize_bot():
    ...
    from aiogram.client.session.aiohttp import AiohttpSession # Import for session
    import aiohttp # Import for session timeout
    ...
    # Create a session with disabled timeout to prevent "Timeout context manager" errors.
    # This is the correct way to handle it in aiogram 3.x.
